...
paged_resource_list_of_failed_delivery_response_instance = PagedResourceListOfFailedDeliveryResponse(next_page=next_page, previous_page=previous_page, values=values, href=href, links=links)
