...
from finbourne_horizon.api_client import ApiClient as AsyncApiClient
...
import finbourne_horizon.extensions.retry as retry
from finbourne_horizon.extensions.socket_keep_alive import keep_alive_socket_options
from finbourne_horizon.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for finbourne_horizon if needed
