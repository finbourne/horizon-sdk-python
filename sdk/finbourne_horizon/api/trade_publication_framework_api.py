...
class TradePublicationFrameworkApi:
    ...
    @overload
    async def get_tpf_transaction_history_search(self, tpf_transaction_search_request : Annotated[Optional[TpfTransactionSearchRequest], Field(description="Search filters and pagination options.")] = None, **kwargs) -> PagedResourceListOfTpfTransactionSearchResponse:  # noqa: E501
        ...

    @overload
    def get_tpf_transaction_history_search(self, tpf_transaction_search_request : Annotated[Optional[TpfTransactionSearchRequest], Field(description="Search filters and pagination options.")] = None, async_req: Optional[bool]=True, **kwargs) -> PagedResourceListOfTpfTransactionSearchResponse:  # noqa: E501
        ...

    @validate_arguments
    def get_tpf_transaction_history_search(self, tpf_transaction_search_request : Annotated[Optional[TpfTransactionSearchRequest], Field(description="Search filters and pagination options.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[PagedResourceListOfTpfTransactionSearchResponse, Awaitable[PagedResourceListOfTpfTransactionSearchResponse]]:  # noqa: E501
        ...
        >>> thread = api.get_tpf_transaction_history_search(tpf_transaction_search_request, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_tpf_transaction_history_search_with_http_info(tpf_transaction_search_request, **kwargs)  # noqa: E501

    @validate_arguments
    def get_tpf_transaction_history_search_with_http_info(self, tpf_transaction_search_request : Annotated[Optional[TpfTransactionSearchRequest], Field(description="Search filters and pagination options.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetTpfTransactionHistorySearch: Search TPF transactions by transaction ID(s) and/or instrument identifier(s), with optional filtering by instance, date range, and publication status. Accepts multiple values in TransactionIds and InstrumentIdentifiers (OR'd within each filter, AND'd between filters).  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_tpf_transaction_history_search_with_http_info(tpf_transaction_search_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/trade-publication-framework/transactions/search', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def retry_failed_delivery(self, instance_id : Annotated[StrictStr, Field(..., description="Integration instance identifier")], tpf_retry_failed_delivery_request : Annotated[TpfRetryFailedDeliveryRequest, Field(description="Request containing batch element reference identifiers to retry")], **kwargs) -> TpfFailedDeliveryResponse:  # noqa: E501
        ...

    @overload
    def retry_failed_delivery(self, instance_id : Annotated[StrictStr, Field(..., description="Integration instance identifier")], tpf_retry_failed_delivery_request : Annotated[TpfRetryFailedDeliveryRequest, Field(description="Request containing batch element reference identifiers to retry")], async_req: Optional[bool]=True, **kwargs) -> TpfFailedDeliveryResponse:  # noqa: E501
        ...

    @validate_arguments
    def retry_failed_delivery(self, instance_id : Annotated[StrictStr, Field(..., description="Integration instance identifier")], tpf_retry_failed_delivery_request : Annotated[TpfRetryFailedDeliveryRequest, Field(description="Request containing batch element reference identifiers to retry")], async_req: Optional[bool]=None, **kwargs) -> Union[TpfFailedDeliveryResponse, Awaitable[TpfFailedDeliveryResponse]]:  # noqa: E501
        ...
        >>> thread = api.retry_failed_delivery(instance_id, tpf_retry_failed_delivery_request, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.retry_failed_delivery_with_http_info(instance_id, tpf_retry_failed_delivery_request, **kwargs)  # noqa: E501

    @validate_arguments
    def retry_failed_delivery_with_http_info(self, instance_id : Annotated[StrictStr, Field(..., description="Integration instance identifier")], tpf_retry_failed_delivery_request : Annotated[TpfRetryFailedDeliveryRequest, Field(description="Request containing batch element reference identifiers to retry")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] RetryFailedDelivery: Retry failed deliveries for Trade Publication Framework  # noqa: E501
        ...
        >>> thread = api.retry_failed_delivery_with_http_info(instance_id, tpf_retry_failed_delivery_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/trade-publication-framework/instances/{instanceId}/failed/retry', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
