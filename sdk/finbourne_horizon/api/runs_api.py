...
class RunsApi:
    ...
    @overload
    async def get_workflow_run_results(self, run_id : Annotated[StrictStr, Field(..., description="Run identifier e.g. \"b64135e7-98a0-41af-a845-d86167d54cc7\".")], **kwargs) -> WorkflowRunResultsResponse:  # noqa: E501
        ...

    @overload
    def get_workflow_run_results(self, run_id : Annotated[StrictStr, Field(..., description="Run identifier e.g. \"b64135e7-98a0-41af-a845-d86167d54cc7\".")], async_req: Optional[bool]=True, **kwargs) -> WorkflowRunResultsResponse:  # noqa: E501
        ...

    @validate_arguments
    def get_workflow_run_results(self, run_id : Annotated[StrictStr, Field(..., description="Run identifier e.g. \"b64135e7-98a0-41af-a845-d86167d54cc7\".")], async_req: Optional[bool]=None, **kwargs) -> Union[WorkflowRunResultsResponse, Awaitable[WorkflowRunResultsResponse]]:  # noqa: E501
        ...
        >>> thread = api.get_workflow_run_results(run_id, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_workflow_run_results_with_http_info(run_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_workflow_run_results_with_http_info(self, run_id : Annotated[StrictStr, Field(..., description="Run identifier e.g. \"b64135e7-98a0-41af-a845-d86167d54cc7\".")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetWorkflowRunResults: Get the status and published result values of an integration run  # noqa: E501
        ...
        >>> thread = api.get_workflow_run_results_with_http_info(run_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/runs/{runId}/workflow/results', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
